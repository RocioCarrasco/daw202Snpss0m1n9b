...
//ELIMINAR DATOS__________________________________________________________
		...
		const DEL_TODAS_FASE="DELETE FROM FASE WHERE PROYECTO=?";
		const DEL_FASE="DELETE FROM FASE WHERE PROYECTO=? AND ID=?";

		const DEL_PROYECTO_TAREA="DELETE FROM TAREA WHERE ID_PROYECTO=?";
		const DEL_FASE_TAREA="DELETE FROM TAREA WHERE ID_PROYECTO=? AND FASE=?";
		const DEL_TAREA="DELETE FROM TAREA WHERE ID_PROYECTO=? AND FASE=? AND ID=?";
