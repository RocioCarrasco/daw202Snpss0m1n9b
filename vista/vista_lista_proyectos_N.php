...
if(Controller::$arrDatos["LSP"]!=NULL){

	for($e=0; $e<sizeof(Controller::$arrDatos["LSP"]);$e++){ 
		$pro=Controller::$arrDatos["LSP"][$e];
...
<!-- <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6" style="border: solid 1px #f1f1f1; background-color: #f1f1f1; padding-bottom: 30px;" >
	 -->
<article id="cont-<?php print Controller::$arrDatos["PRO"][$indice][0]['id_proyecto']; ?>">
	<h3><a onclick="xajax_load_proyecto('<?php print Controller::$arrDatos["PRO"][$indice][0]['id_proyecto']; ?>');"><?php print Controller::$arrDatos["PRO"][$indice][0]['title_proyecto'] ?></a></h3>

	<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
		<h5>Descripción</h5>
		<span><?php print Controller::$arrDatos["PRO"][$indice][0]['descripcion_proyecto']; ?></span>	
	</div>
	...
	<div>
		<h5>Admin</h5>
<?php for($i=0;$i<sizeof(Controller::$arrDatos["PRO"][$indice]);$i++){ ?>
		<span><?php if(Controller::$arrDatos["PRO"][$indice][$i]["id_rango"]==0) print Controller::$arrDatos["PRO"][$indice][$i]['nick_user'];
...
<?php	} ?>
	...
	<div>
		<h5>Collaborators</h5>
<?php for($i=0;$i<sizeof(Controller::$arrDatos["PRO"][$indice]);$i++){ ?>
		<span><?php print Controller::$arrDatos["PRO"][$indice][$i]['nick_user'];
...
<?php	} ?>
		...
		<div>
			<button onclick="xajax_delProyecto('<?php print Controller::$arrDatos["PRO"][$indice][0]['id_proyecto']; ?>');">Eliminar</button>
		</div>
	</div>
